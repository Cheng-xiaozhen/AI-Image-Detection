...
@register_model("convnext2")
class ConvNext2(nn.Module):
    def __init__(self,backbone_name="timm/convnextv2_base.fcmae_ft_in22k_in1k_384",num_classes=1,fix_backbone=False):
        super(ConvNext2, self).__init__()
